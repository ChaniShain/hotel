...
import { Box, Button, Card, CardContent, CardMedia, Chip, Divider, FormControl, Grid, IconButton, InputLabel, MenuItem, Select, SelectChangeEvent, TextField, ThemeProvider, Typography, makeStyles } from '@mui/material';
        ...
        <Grid container spacing={{ xs: 4, md: 4 }} direction="row-reverse" >
          <Grid item xs={3} md={3}>
            <Typography >
              ...
              <strong>בשבת ומוצאי חג שעת <br />קבלת חדרים החל מ:</strong> 17:00
            </Typography>
          </Grid>
          <Grid item xs={3} md={3}>
            <Typography >
          ...
          <Grid item xs={3} md={3}>
            <Typography >
              ...
              <strong> :הסדרי חנייה </strong><br /> חניה חיצונית בתשלום של 75 ₪ ליום <br />שבע ימים בשבוע , 24 שעות<br />(על בסיס מקום פנוי בלבד)<br />
            </Typography>
          </Grid>
          <Grid item xs={3} md={3}>
            <Typography >
